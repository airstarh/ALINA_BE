...
ALINA_PERMISSIONS "$ALINA_USER_MYSQL" "$ALINA_GROUP_MYSQL" "database"
# chmod 640 ./database/mysql/mysqld-auto.cnf
...
ALINA_PERMISSIONS "$ALINA_USER_NGINX" "$ALINA_GROUP_NGINX" "server/srv/sewa/cert005gemini"
