...
export ALINA_REMOTE_HOST="${BBB_REMOTE_HOST:-bbb}"
export ALINA_REMOTE_USER="${BBB_REMOTE_USER:-sewa}"
...
export ALINA_BASES=("borg")
export A_LIST_PROJECTS=("borg.home")
export ALINA_DEFAULT_PROJECT="borg.home"
