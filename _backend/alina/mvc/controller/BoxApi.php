...
class BoxApi
{
    ...
    public function boxApiConfig()
    {
        return [
            'folder_id'                       => 0,
            'access_token_storage'            => __DIR__ . '/access-token-storage',
            'access_token_storage_enterprise' => __DIR__ . '/access-token-storage-enterprise',
            'header'                          => [
            ...
            //'signature' => file_get_contents(__DIR__.'/public_key.pem'),
            'signature'                       => [
