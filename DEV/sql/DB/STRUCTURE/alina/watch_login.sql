...
-- Dumping structure for table alina.watch_login
DROP TABLE IF EXISTS `watch_login`;
CREATE TABLE IF NOT EXISTS `watch_login` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `mail` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ip` char(46) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `browser_enc` varchar(256) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
